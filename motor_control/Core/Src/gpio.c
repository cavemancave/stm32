...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, VCC_OUT1_EN_Pin|Power_5V_EN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, ACC_CS_Pin|GYRO_CS_Pin, GPIO_PIN_SET);

  /*Configure GPIO pins : VCC_OUT1_EN_Pin Power_5V_EN_Pin */
  GPIO_InitStruct.Pin = VCC_OUT1_EN_Pin|Power_5V_EN_Pin;

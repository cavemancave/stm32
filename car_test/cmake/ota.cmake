...
#
# ⚠⚠ 下面这份库清单是**手写的**，主目标的那些 `include(cmake/xxx.cmake)` 里
#     `target_link_libraries(${CMAKE_PROJECT_NAME} xxx)` 不会自动跟过来 ——
#     新加一个库（比如 motor_drive）时**两处都要加**，否则只有 B 槽会在链接时
#     报 undefined reference（A 槽没事），看起来像"同一个源码两份镜像行为不一样"。
# ---------------------------------------------------------------------------
